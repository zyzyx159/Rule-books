...
The Characteristic gets halved before any situational modifiers get applied to the test. An Easy test against an untrained Basic Skill would be (Characteristic/2)+30, and not (Characteristic+30)/2.
## **Advanced Skills**
...
Some Skills are flagged with special descriptors such as combat, crafting, interaction, investigation, movement or operator. These Skills carry various special rules that govern their usage. In summary, Crafting Skills are those used to create items from scratch and spare parts. Interaction Skills are those used when interacting with NPCs. Investigation Skills are those used to ferret out additional information about a subject. Movement Skills offer alternative means to get around your environment. And finally, Operator Skills allow you to operate a vehicle.
### **Crafting Skills**

Certain Skills enable you to create items from parts and materials. To do so, you must have the materials, as determined by the GM, available. You then test the appropriate Skill (e.g. Chem-Use or Trade) applying any bonuses or penalties due to the quality of materials, environmental factors and anything else as determined by the GM. On a success, you generate the item. Note that the quality/finish/usefulness of the item improves for each degree of success gained. Failing by three degrees indicates you have ruined some of the materials. Failing by five or more degrees indicates that you have completely ruined all of the Skill Group's materials and must start over from scratch. Note that the time it takes to create the item is determined by the GM.

Details on the steps for creating items can be found in [**Crafting**](crafting.md).
### **Interaction Skills**

During a game session, a player doesn’t need to make Interaction Tests every time he has a conversation or makes a transaction. For simple actions that carry little or no jeopardy, the player simply plays the role of his character. The outcome of these interactions between the character and the NPCs are then determined by the GM. However, a player should make an appropriate Skill Test if there are consequences for failure, or if success would serve to advance the plot in a considerable way. Examples that would require a Skill Test include attempting to convince an NPC to do something that is dangerous to them in some way, or in direct violation of that NPC’s morality or honour, such as accepting a bribe, murder for hire, or parting with an object they'd rather not give up. Ultimately, when a player does or does not need to make a Skill Test is up to the GM’s discretion, and he has final say on the outcome of the encounter.
#### **Example**
*Samshir is attempting to convince a junior Imperial Guard officer to abandon his post and take his men with him. Because this would be incredibly harmful to the young officer, and completely against his training, the GM decided that Samshir needs to make a Deceive Test to convince the officer that doing so would, in fact, be a good idea.*
#### **Dispositions**

When making an Interaction Skill Test, there are a number of variables that dictate the final difficulty of the Test. These can include atmosphere, situation, and an NPC’s particular circumstances. Most important, however, is how the NPC is disposed toward the Player Characters—how the character regards the NPC and what feelings (or lack thereof) the NPC displays. The NPC’s disposition, which is always set by the GM, determines the base Difficulty of any encounter. Other factors can adjust the difficulty up or down as the situation demands and as the GM sees fit. **Table: Dispositions** provides sample dispositions based on specific Tests and their corresponding difficulty.

With an Interaction Test, the target’s Disposition improves by one step on a successful Test, plus one step per degree of success. On a failed Test, the target's Disposition remains unchanged and worsens by one step for each degree of failure. 
...
#### **Table: Dispositions**
| Difficulty       | Charm        | Command     | Deceive      | Intimidate  |
| ---------------- | ------------ | ----------- | ------------ | ----------- |
...
**Table: Investigation Benchmarks** offers a selection of example Difficulties, times and Actions based on secrecy. As with many other Tests, you may benefit from assistance from other Player Characters subject to the same limitations described under [Assistance](tests.md#assistance).
...
#### **Table: Investigation Benchmarks**
| Complexity   | Difficulty       | Example                                | Time     |
| ------------ | ---------------- | -------------------------------------- | -------- |
...
| Taxing       | Challenging (+0) | Identifying an obscure poison          | 3 days   |
| Involved     | Difficult (–10)  | Tracing the origin of a machine spirit | 14 days  |
| Arduous      | Hard (–20)       | Translating an entire book             | 1 month  |
| Labyrinthine | Very Hard (–30)  | Cataloguing a large datacrypt          | 1 year   |
## **Skill Groups**
...
**(Advanced)** 
**Intelligence**
**Skill Groups:** Acolyte, War Cant, Secret Society, Occult, Underworld
...
Many Inquisitors develop their own Ciphers to communicate their instructions to their Acolytes, while also giving a vital tool for use between their servants while on missions. Whilst the Skill Groups for this Skill are quite broad, you can make them more specific, effectively creating sub-groups for each sub-skill. When using the Ciphers Skill to discern or translate the meaning of the code of which you do not actually know, but is within a Skill Group for which you are trained, you may Test Ciphers normally, but at a –20 penalty.
...
**Compel:** This expanded function works just like the [Charm special rule **bamboozle**](skills.md#charm) except it applies to Command Tests.
...
Other Common Lores may be available at the GM's discretion.
...
**Famous Stratagems:** Whenever you would be called upon to make a Scholastic Lore (Tactica Imperialis) Test, you may instead make a Common Lore (Imperial Guard or War) Test, but at a –20 penalty, so long as the Test relates to famous battles or strategies.
...
**Camouflage:** Whenever you would attempt to conceal another character, you can Test Concealment and apply the results of your Test for that character. The effects of a successful Test remain only so long as that character has the benefit of cover, reduced visibility (fog, foliage, etc.), and does not move. If the concealed character moves, he is no longer concealed.
...
**Defraud:** This expanded function works just like the [Charm special rule **bamboozle**](skills.md#charm) except it applies to Deceive Tests.
...
If you're the sort who fights for a living, being able to leap out of the way of lasbolts or flying punches is a vital skill for your survival. 
...
**(Advanced, Investigation)** 
**Intelligence**
**Skill Groups:** The Black Library, Cults, Daemonology, Heresy, Inquisition, Archeotech, Mutants, Ordos, Adeptus Mechanicus, Psykers, Pirates, Warp, Xenos
...
Other Forbidden Lores may be available at the GM's discretion.
...
Inquiry can also be used as an Investigation Skill, wherein you might be chasing after a particular fact or secret. For more information on investigation, see **Investigation.** Furthermore, it is the primary means by which you ascertain the availability of items and gear you may wish to purchase or otherwise acquire—an exceedingly useful Skill indeed.
...
A Performer Test can take a variable amount of time depending upon the performance in question. A short poem or parable might only last a few Rounds, while an elaborate and long-winded opera could take an hour or more.

Other Performer Skill Groups may be available at the GM's discretion.
## **Pilot** 
**(Advanced, Operator)** 
**Agility**
**Skill Groups:** Civilian Craft, Military Craft, Personal, Spacecraft
...
Other Pilot Skill Groups may be available at the GM's discretion.
...
**Diminish Psychic Attack:** Psyniscience allows you to perceive the intricate weaves of power involved in the manifestation of a Psychic Power. Whenever you are the target of a Psychic Power, you may make a **Very Hard (–30) Psyniscience Test**. If you succeed, you negate the effects of any of the power’s Overbleed.
...
**(Advanced, Investigation)**
**Intelligence**
**Skill Groups:** Archaic, Astromancy, Beasts, Bureaucracy, Chymistry, Cryptology, Heraldry, Imperial Creed, Judgement, Legend, Numerology, Occult, Philosophy, Tactica Imperialis
...
Other Scholastic Lores may be available at the GM's discretion.
##### **Practical Knowledge** 
...
**(Advanced)** 
**Intelligence**
**Skill Groups:** Acolyte, Administratum, Ecclesiarchy, Gutter, Military, Tech
...
Other Secret Tongues may be available at the GM's discretion.
...
A Security Test takes one minute, with each degree of success reducing this time by ten seconds. Note that very large, intricate, or complex systems may require Extended Tests. The following special rules are associated with this Skill:
...
**(Advanced)** 
**Intelligence**
**Skill Groups:** Eldar, High Gothic, Hive Dialect, Low Gothic, Ork, Ship Dialect, Techna-Lingua, Tribal Dialect
...
**Techna-Lingua:** Unique to the Adeptus Mechanicus, this is a binary language that has been optimised for rapid communication of technical data and servitor commands. To non-speakers, it simply sounds like brief, rapid bursts of ear-grating auditory machine code. Unaugmented humans generally cannot speak or understand Techna-Lingua without some form of technical assistance.
...
Other languages may be available at the GM's discretion.
...
Some more common Trades an Acolyte may encounter or have the chance to learn themselves are as listed below. Other Trades may be available at the GM's discretion.
#### **Table: Trade Skill Lore**
| Degrees of Success | Trade Lore                                                                                                     |
| ------------------ | -------------------------------------------------------------------------------------------------------------- |
| Standard           | Basic facts about an item, its name, and properties.                                                           |
| One                | Process and materials used to create the item, its classification or group, general stellar region of origin.  |
| Two                | Origin of components used in construction, detailed information about its characteristics, planet of creation. |
| Three or more      | Substitutes for the item, means of amplifying its effects, name of its creator.                                |
#### Trade (Archaeologist)
**(Advanced)**
**Intelligence**
...
The Trade (Armourer) Skill is used to create, modify or repair arms and armour, from simple tasks such as adding a fire selector to a bolt pistol to the complex design of combi-weapons and artificer armour. This Skill deals with personal weapons and protection rather than vehicular or large-scale systems, which are covered by the Trade (Shipwright) Skill for void ships and Trade (Wright) for everything else.

One of the most commonly used Skills and potentially most useful in everyday application, Trade (Armourer) grants you unparalleled creativity in customising your kit. Keep in mind, however, that some technologies are simply beyond the capabilities of all but the most learned of the Adeptus Mechanicus. No Acolyte, however skilled, could create or repair weaponry from the Dark Age of Technology, and certain weapons of xenos origin could be out of the question as well. As usual, the GM should be the final judge in such matters.

You will still find a bewildering number of possibilities available for the alteration and upgrading of weapons and armour, from creating adamantine blades (without the Primitive attribute) to customising armour for its wearer (giving it the perks of Good Craftsmanship due to its exceptional fitment). Simple upgrades, such as those found in the *Macharian Handbook*, only require a simple Skill Test, but the creation of a more elaborate modification of armaments uses the Crafting rules. While by no means an exhaustive list, **Table: Armourer Test Difficulty** serves as a guideline for determining Crafting Difficulty.
...
##### Table: Armourer Test Difficulty
| Difficulty       | Example                                                               |
| ---------------- | --------------------------------------------------------------------- |
| Simple (+40)     | Engraving an aquila or monogram onto a weapon or armour               |
| Easy (+30)       | Repairing cosmetic damage; attaching a sight to a gun with a mount    |
| Routine (+20)    | Adding a fire selector or attaching a sight to a gun without a mount  |
| Ordinary (+10)   | Adapting parts from one weapon to another; minor repairs to weapons   |
| Challenging (+0) | Converting a weapon to a compact version; adding unusual upgrades     |
| Difficult (–10)  | Repairing damaged armour; major repairs to weapons                    |
| Hard (–20)       | Assembling a combi-weapon; adding reinforcement to armour             |
| Very Hard (–30)  | Crafting power weapons; removing the Unreliable quality from a weapon |
#### Trade (Artist)
**(Advanced, Crafting)**
...
Art can affect the mood of those observing it in many ways, including inspiration, sadness, anger and others. If the artist wants his work to affect the audience in a particular way, this should be defined in Step One: Defining the Task of the Crafting rules. The GM assigns a different Difficulty to creating a mural that inspires a positive reaction to the Adeptus Mechanicus than one without additional effects. Keep in mind, however, that these are modest effects. While the viewer may feel inspired by the art, it will not cause him to change or act against firmly held beliefs.

The creation of an inspirational art piece is **Hard (–20)** for concepts coinciding with local culture, such as veneration of the God-Emperor within the Imperium, but is **Very Hard (–30)** for anything that significantly goes against such conventions, such as fostering a more positive reaction to xenos when viewed in the Imperium.
#### Trade (Cartographer)
**(Advanced, Crafting)**
**Agility**

You can produce maps and charts of high quality from information gathered first hand or by others. The Craftsmanship of these documents can affect the Navigation (Surface) Tests of those using them. Likewise, you are able to read maps made by others more easily, obtaining hidden or obscure information left by other cartographers.

The cartographer must use observation or research to gain adequate information to create a map. The GM should keep this in mind when assigning the duration of a task, as large maps require lengthy examination and groundwork. The [Heightened Senses (Sight) Talent](talents.md#heightened%20senses) can reduce the Difficulty of the task by one level if gathering data personally, so the Difficulty of creating a map of a labyrinthine Ecclesiarchy cathedral would be reduced from **Difficult (–10)** to **Challenging (+0)**.
...
Note that this Trade Skill can only be used to create maps suitable for terrestrial navigation. Star charts, the astromantic maps used to plot courses for voidships in the warp, are largely confined to the purview of the Navis Nobilite, and would be far beyond the means of a common Acolyte.
#### Trade (Cook)
**(Advanced, Crafting)**
**Intelligence**

An Acolyte with this Skill can create meals not only pleasing to the palate, but also ones of desired nutritional content—or lack thereof. The results of this Skill can also be combined with Carouse, Chem-Use or Trade (Apothecary) in making drinks or medicines that taste better, or the creation of foods that mask certain flavours from those ingesting them. The GM should set the Difficulty of the task in accordance with the traits desired. Creating a simple but nutritious meal for fellow Acolytes might be Ordinary (+10); cooking a dish to mask a bland-tasting drug for a noble’s entourage would be Difficult (–10); or devising a meal nutritious for a xenos creature could be Very Hard (–30) or worse.

Acolytes can also use this Skill to determine the ingredients or origins of foods they consume, or notice out of the ordinary tastes, using **Table: Trade Skill Lore**. They can also make an Opposed Skill Test against the subject’s Perception to either hide or reveal hidden substances within a dish or drink.
...
Copyists in the 41st Millennium are far more than mindless scribes scratching out data sheets with an electro-quill. Though certainly capable of this task, an Acolyte with the Copyist Skill creates illuminated manuscripts of great beauty, containing anything from family histories to epic ballads. A talented copyist is of immediate interest to an Inquisitor—aside from being able to draw up pleasing formal reports at the end of an investigation, this Skill is also used to create forgeries, which can be a vital tool in cracking open the operations of a heretical cult.
...
An Acolyte with the Trade (Embalmer) Skill can preserve the deceased, as well as almost any organic material, animal or plant, though some things require more elaborate treatments and substances than others. This Skill also allows you to reconstruct recently dead plants, animals or persons into a semblance of their unblemished living appearance. The process often requires chemicals and fluids with noxious odours, resulting in a somewhat negative public opinion of this otherwise-vital trade.

Whilst respectfully attending to the dead is a good and noble profession, the reconstructive aspects of this Skill can also be of great use in an investigation. With access to physical remains, a trained embalmer could develop significant insight into the appearance the deceased had in life. The Difficulty for this Test depends on the condition of the remains—determining the face of a recently disfigured murder victim would be fairly straightforward, while recreating the appearance and thus identity of a decomposed or skeletal body could be quite an endeavour, especially if there are a lot of missing parts. As a general rule of thumb, a successful Trade (Embalmer) Test reveals basic information about the body in question, with additional degrees of success revealing greater details. Three or more degrees of success is sufficient to reconstruct the appearance of the deceased entirely.

#### Trade (Linguist)
**(Advanced, Crafting)**
**Intelligence**

While the God-Emperor's subjects are officially united in the Gothic language, the fact of the matter is there are a dizzying range of tongues and dialects that exist across the breadth of the Imperium—to say nothing of the foul speaking mannerisms of the xeno and the mutant. Linguists are trained in the academic study of language and communication, able to assist in active translation between those with no common tongue. Furthermore, a linguist is capable of drafting manuals and guides to help contain this information in a portable form—handy for off-world traders or Imperial Guard officers deploying to a planet where the Gothic tongue is not widespread. A trained linguist might be a more common member of a Rogue Trader's retinue, but could be equally valuable to the employ of a planet-hopping Inquisitor, especially if they happen to serve under the Ordo Xenos.

You may use the Trade (Linguist) Skill to improve your ability to translate other languages. With success, you gain a +10 bonus on any Speak Language Skill Tests made to comport different languages at once, with each degree of success granting an additional +10 bonus (to a maximum of +30). 

Alternatively, this Skill can be used to create instructional media to assist others in communicating in another language that they don't speak themselves. If you have the relevant Speak Language Skill yourself, you may use the Crafting rules to draw up a handbook for others to aid them in their linguistic deficiency. The utility of your manual depends on its Craftsmanship. A manual of Poor Craftsmanship isn't sufficient to actually speak the language, but does provide a +10 bonus to Fellowship Tests made to pantomime to the other party. A Common Craftsmanship manual provides a +10 bonus to Speak Language Tests when attempting to communicate in a language the reader does not possess, while a Good Craftsmanship manual increases the bonus to +20. A Best Craftsmanship manual is a true treasure—the reader may use the manual to speak the language in question without actually having the relevant Speak Language Skill, although the pace of speaking is quite slow as the reader must continually reference the manual each time the conversation advances.

#### Trade (Mason)
**(Advanced, Crafting)**
**Agility**

Masons erect structures, monuments, walls and fortifications out of stone blocks, mortar or cement. Depending on the desired result, materials may include cobblestone, granite, ouslite, marble or any of a number of materials. This Skill also covers the use of rockcrete, a ubiquitous building material for Imperial structures and fortifications where speed of construction outweighs artistic concerns, and various reinforcements to stonework with iron or plasteel.

Given the scale of most masonry projects and the gross weight of the materials involved, most Acolytes will wish to use the Cooperation rules, or at the very least some strong-backed servitors. With the hectic pace of Inquisitorial work, it’s unlikely that circumstance will allow them time to personally fit each piece of stone for a project. Labour or servitors that simply move blocks of stone rather than practising the skilled aspects of this trade do not count against the Cooperation rules.
...
As most mining is done underground, having this Trade grants a +10 bonus on Navigation (Surface) Tests when inside large or underground structures, such as the underhive or tunnels.
#### Trade (Prospector)
**(Advanced, Crafting)**
**Strength**

Acolytes with the Trade (Prospector) Skill can survey an area to determine if it contains potentially valuable resources. Note that they will only be able to determine if those materials might be present, not their exact quantity, nor are they likely to discover things far removed from the subject of their search—although serendipitous, or unfortunate, findings are always possible.

When the Acolyte and GM look at Step One: Define the Task of the Crafting rules, they should carefully delineate the search, ensuring it is not too broad in scope. Thus, searching ten square kilometres for evidence of underground Promethium is perfectly acceptable, while prospecting “the plains” for “any valuable ores” would only be satisfactory if the Acolyte were armed with extensive testing apparatus and an army of assistants to comb through such a broad area. Simply searching for “any resources” is right out.
...
An Acolyte with the Trade (Shipwright) Skill is capable of designing and overseeing the construction of one of mankind's greatest technical achievements: void-capable starcraft. This Skill encompasses the fundamentals of construction techniques and the technical base of various esoteric subjects specifically germane to voidships, including life sustainers, void shields, and even Gellar fields. Shipwrights are also of vital importance to the maintenance of existing voidcraft, which must undergo periodic overhauls to preserve their resilience against the ravages of the cruel and heartless void.

This Skill uses the Crafting rules, with scale and complexity directly tied to the type of voidcraft in question. An assault boat with up-rated engines would be on the smaller size, while a multi-kilometre mass conveyor would be naturally much closer to the top. After completion of the design, the construction is a separate Crafting task, using the appropriate Trade Skills, such as Trade (Armourer) for the voidship's systems and Trade (Smith) for its hull. Except for the smallest of vessels a shipwright must usually enlist the help of others to realise their plans.

Designing a larger voidship would almost certainly require both the Cooperation rules as well as judicious use of Dividing Tasks to bring the design time down to something reasonable. A single shipwright would take many months, if not a year or more, to design the entire deck plan of a cruiser, but could likely devise a single frame section of the hull (of which there are many) in a few weeks. Split among a cadre of other shipwrights, the cruiser would take form one section at a time as the plan forms are integrated with one another, each shipwright moving on to the next of their assigned tasks until the vessel is fully assembled.

While perhaps not an immediately obvious use, a trained shipwright can also intuit information and various insights about the construction and capabilities of existing voidcraft, such as whether a lighter is capable of atmospheric operation, or the approximate age and provenance of a wreck encountered in deep void. 
#### Trade (Smith)
**(Advanced, Crafting)**
**Strength**

A character with the Trade (Smith) Skill can shape or reshape metal, smelt alloys from ingots or ore, and forge all manners of weapons, tools and armour. Unlike some Trade Skills, a smith requires a potentially extensive workshop, to include a heat source (forge), hammer block (anvil) and hammer, which may be powered by the smith’s arm or a machine. While a metalsmith working in gold or platinum might have a closet-sized workshop and miniature tools, the power hammers required for large-scale projects—or harder metals such as adamantium—can weigh upwards of 100 tonnes. Forges can vary in size from that of a ration box for a portable model to the legendary Titan-works on Mars that dwarf all but the grandest of Ecclesiastical cathedrals.
...
A successful Skill Test convinces the subject of the authenticity of the soothsayer’s skills. After this, the player and GM should discuss the time frame and desired outcome of the fortunetelling sessions using the Crafting rules.
#### Trade (Tanner)
**(Advanced, Crafting)**
**Strength**
...
Different animal hides necessitate different tanning methods, in both method and duration of the process. Generally, the more thick, tough or durable the skin, the more steps are necessary for treatment. Tanners require suitable chemicals for each step of the process, which due to their noxious smell often banish the trade to the outskirts—or under levels—of many cities. This may make them unpopular with their fellow Acolytes if operating out of cramped quarters.

You can also use this Skill to determine the type of creature from which a particular leather was manufactured, using **Table: Trade Skills Lore**.
#### Trade (Technomat)
**(Advanced, Crafting)**
**Intelligence**

The Trade (Technomat) Skill differs from most of the other Trade Skills in that it represents the care and maintenance of items rather than their creation. However, as the mysteries of creation for many items from the Dark Age of Technology are now jealously guarded by the Adeptus Mechanicus, or in some cases actually and truly forever lost, this Skill has great value throughout the Imperium.

A technomat represents a broad segment of technical laymen—skilled labourers who are versed in the necessary rites to service and maintain technology, but who lack a formally ordained tech-priest's greater knowledge of machine spirits and other techno-esoterica. An Acolyte so trained would be fully aware of the efficacy of the holy oils and unguents, specific chants made in the haze of an incense burner, and the correct application of a sacred spanner onto a rune of ignition, but is otherwise largely ignorant of the underlying purpose any of those procedures serve to keep the machine in question functioning. That knowledge is reserved by the Mechanicus—the technomat need only know the what and the how, not the why.

An Acolyte trained as a technomat can repair and modify gear and equipment as if they had the Trade (Armourer) Skill, although not as easily given their more rudimentary knowledge of the fundamentals of the machine. You may substitute Trade (Technomat) for Trade (Armourer) when performing repairs or modifying equipment, however the difficulty of such Tests increase by one-step, and you generally cannot create items from scratch. Further, the GM may decide that certain pieces of gear are simply too arcane or complex to be worked on using this Skill.
...
You have the ability to shrewdly provide for the needs of another for a range of requirements, including administrative and personal needs, and can even supervise a staff administering to these needs on a larger scale. Individuals with this Skill often use the title “majordomo” or “chief of staff”.

At the most trivial level, this Skill addresses immediate concerns, such as selection of appropriate apparel for a meeting with an Imperial Governor or picking a suitable refreshment for a Clan Lord of Tallarn. Successful use of this Skill grants a +10 bonus on all Tests of an Interaction Skill of your choice, for either yourself or the host, representing the favourable impression generated by these thoughtful touches. For every two degrees of success on this Test you may designate an additional Interaction Skill to receive this bonus. The effect lasts for the duration of the event you were preparing for.
...
For these long-term Tests, the resultant Craftsmanship may impart certain bonuses at the GM's discretion.
#### Trade (Wright)
**(Advanced, Crafting)**
**Intelligence**

Acolytes use the Trade (Wright) Skill for large-scale design and construction Tests. Buildings, bridges, monuments, industrial works, and terrestrial vehicles fall under this broad expertise. While this Skill grants you the ability to design structures and vehicular systems, an Acolyte will rarely have all the tools and equipment necessary to realise his designs without significant outside assistance. It’s all well and good to design a 200 metre marble arch celebrating the victory of Imperial forces over the Overfiend of Octarius, but quite another to actually build it!
...
You may also use the Trade (Wright) Skill to gain information about the constructs or fabrications of others, such as the STC design upon which a speeder was based or the school of design for a bridge. Use **Table: Trade Skill Lore** as a guide to determine the information gained.

Note this Skill does not cover the design and construction of void-capable starcraft—see Trade (Shipwright) for that particularly challenging task.
## **Wrangling 
(Advanced) 
Intelligence

Despite the great technological advancements of the Imperium, many worlds still rely on beasts of burden to carry them about. An Acolyte who is as comfortable on a riding mount as he is on a bike will rarely be left without a mode of transport.

This Skill may be used in order to ride domesticated animals of appropriate size.

The Wrangling Skill also allows you to care for and control domesticated animals, like horses, bloodhounds, Spike Pigs, Grox, and the like. Routine care and feeding requires no Test, but you may be called to make one to spot developing illnesses or signs of discomfort, or for special grooming (preparing a mount for a parade, for instance).
...
Wrangling is of no use against cybernetic or synthetic creatures, such as cyber-mastiffs or grapplehawks—even if they are built to resemble an animal, you must still use the Tech-Use Skill to wrangle such things.
